...
genai.configure(api_key="AIzaSyDQZ_dKNC9KD6OCXSzJQ7klObB3s1h7JuQ")
...
input_prompt = """
You are an expert in reding invoices. We are going to upload an image of an invoice
and you will have to answer any type of questions thta the user  asks you.
